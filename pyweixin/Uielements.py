...
class Buttons():
    ...
    def __init__(self):
        ...
        self.MomentsButton={'title':'朋友圈','control_type':'Button','class_name':"mmui::ExtensionDiscoverContentCell",'found_index':0}#发现界面里的朋友圈按钮
        self.ChannelsButton={'title':'视频号','control_type':'Button','class_name':"mmui::ExtensionDiscoverContentCell",'found_index':0}#发现界面里的视频号按钮
        self.SearchButton={'title':'搜一搜','control_type':'Button','class_name':"mmui::ExtensionDiscoverContentCell",'found_index':0}#发现界面里的搜一搜按钮
        self.MiniProgramButton={'title':'小程序','control_type':'Button','class_name':"mmui::ExtensionDiscoverContentCell",'found_index':0}#发现界面里的小程序按钮
...
class TabItems():
    def __init__(self):
        ...
        self.PhotoAndVideoTabItem={'title':'照片和视频','control_type':'TabItem','class_name':'mmui::XButton','framework_id':'Qt'}#微信聊天记录界面里顶部的照片和视频Tabitem
